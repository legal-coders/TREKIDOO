...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("../States/img/goa/chapora_beach/chapora_beach1.jpg")';
  });
}

hoverbg(no1, "../States/img/goa/bondla_wildlife_sanctuary/bondla_wildlife_sanctuary1.jpg");
hoverbg(no2, "../States/img/goa/calangute_beach/calangute_beach1.jpg");
hoverbg(no3, "../States/img/goa/chapora_beach/chapora_beach2.jpg");
hoverbg(no4, "../States/img/goa/church_of_our_lady_of_hope/church_of_our_lady_of_hope1.jpg");
hoverbg(no5, "../States/img/goa/divar_island/divar_island1.jpg");
hoverbg(no6, "../States/img/goa/mangesh_temple/mangesh_temple1.jpg");
hoverbg(no7, "../States/img/goa/reis_magos/reis_magos1.png");
hoverbg(no8, "../States/img/goa/shanta_durga_temple/shanta_durga_temple1.jpg");
hoverbg(no9, "../States/img/goa/reis_magos/reis_magos3.jpg");
hoverbg(no10, "../States/img/goa/shanta_durga_temple/shanta_durga_temple3.jpeg");
hoverbg(no11, "../States/img/goa/divar_island/divar_island4.jpg");
