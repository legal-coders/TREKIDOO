...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/Telangana/Ananthagiri-Hills.jpg")';
  });
}

hoverbg(no1, "/Places/states_img/Telangana/Ananthagiri-Hills.jpg");
...
hoverbg(no9, "/Places/states_img/Telangana/Ananthagiri-Hills.jpg");
hoverbg(no10, "/Places/states_img/Telangana/Chowmahalla.jpg");
hoverbg(no11, "/Places/states_img/Telangana/Golkonda_Fort.jpg");
