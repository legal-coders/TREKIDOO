...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("../States/img/Uttatkhand/images (33).jpeg")';
  });
}

hoverbg(no1, "../States/img/Uttatkhand/images (29).jpeg");
hoverbg(no2, "../States/img/Uttatkhand/images (30).jpeg");
hoverbg(no3, "../States/img/Uttatkhand/images (31).jpeg");
hoverbg(no4, "../States/img/Uttatkhand/images (32).jpeg");
hoverbg(no5, "../States/img/Uttatkhand/images (33).jpeg");
hoverbg(no6, "../States/img/Uttatkhand/images (34).jpeg");
hoverbg(no7, "../States/img/Uttatkhand/images (35).jpeg");
hoverbg(no8, "../States/img/Uttatkhand/images (36).jpeg");
hoverbg(no9, "../States/img/Uttatkhand/images (37).jpeg");
hoverbg(no10, "../States/img/Uttatkhand/images (29).jpeg");
hoverbg(no11, "../States/img/Uttatkhand/images (30).jpeg");
