...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/Ladakh/Ladakh.jpg")';
  });
}

hoverbg(no1, "/Places/states_img/Ladakh/edited-image-1.jpg");
hoverbg(no2, "/Places/states_img/Ladakh/jpg.jpg");
hoverbg(no3, "/Places/states_img/Ladakh/ladakh2.jpg");
hoverbg(no4, "/Places/states_img/Ladakh/lake-ladakh-tso-kar.jpg");
hoverbg(no5, "/Places/states_img/Ladakh/Mountains-Monastories-Ladakhjpg.jpg");
hoverbg(no6, "/Places/states_img/Ladakh/pangong-lake-ladakh.jpg");
hoverbg(no7, "/Places/states_img/Ladakh/pexels-julia-volk-5204945.jpg");
hoverbg(no8, "/Places/states_img/Ladakh/pexels-julia-volk-5205010.jpg");
hoverbg(no9, "/Places/states_img/Ladakh/pexels-nirali-patel-5571279.jpg");
hoverbg(no10, "/Places/states_img/Ladakh/pexels-nirali-patel-5571291.jpg");
hoverbg(no11, "/Places/states_img/Ladakh/Shyok_river_Ladakh.jpg");
