...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("../States/img/west bengal/images (55).jpeg")';
  });
}

hoverbg(no1, "../States/img/west bengal/images (50).jpeg");
hoverbg(no2, "../States/img/west bengal/images (51).jpeg");
hoverbg(no3, "../States/img/west bengal/images (52).jpeg");
hoverbg(no4, "../States/img/west bengal/images (53).jpeg");
hoverbg(no5, "../States/img/west bengal/images (54).jpeg");
hoverbg(no6, "../States/img/west bengal/images (55).jpeg");
hoverbg(no7, "../States/img/west bengal/images (56).jpeg");
hoverbg(no8, "../States/img/west bengal/images (58).jpeg");
hoverbg(no9, "../States/img/west bengal/images (50).jpeg");
hoverbg(no10, "../States/img/west bengal/images (51).jpeg");
hoverbg(no11, "../States/img/west bengal/images (52).jpeg");
