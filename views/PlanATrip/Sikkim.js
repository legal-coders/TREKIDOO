...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/Sikim/Teesta-River.jpg")';
  });
}

hoverbg(no1, "/Places/states_img/Sikim/gangtokk.jpg");
hoverbg(no2, "/Places/states_img/Sikim/goecha_la.jpg");
hoverbg(no3, "/Places/states_img/Sikim/nathula_pass.jpg");
hoverbg(no4, "/Places/states_img/Sikim/pelling.jpg");
hoverbg(no5, "/Places/states_img/Sikim/Sikkim-Gurudongmar-Lake.jpg");
hoverbg(no6, "/Places/states_img/Sikim/Teesta-River.jpg");
hoverbg(no7, "/Places/states_img/Sikim/tsomgo_lake.jpg");
hoverbg(no8, "/Places/states_img/Sikim/tsomgo_lake.jpg");
hoverbg(no9, "/Places/states_img/Sikim/zuluk.jpg");
hoverbg(no10, "/Places/states_img/Sikim/gangtokk.jpg");
hoverbg(no11, "/Places/states_img/Sikim/goecha_la.jpg");
