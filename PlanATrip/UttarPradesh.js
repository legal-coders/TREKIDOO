...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("../States/img/Utrar pradesh/images (33).jpeg")';
  });
}

hoverbg(no1, "../States/img/Utrar pradesh/images (29).jpeg");
hoverbg(no2, "../States/img/Utrar pradesh/images (30).jpeg");
hoverbg(no3, "../States/img/Utrar pradesh/images (31).jpeg");
hoverbg(no4, "../States/img/Utrar pradesh/images (32).jpeg");
hoverbg(no5, "../States/img/Utrar pradesh/images (33).jpeg");
hoverbg(no6, "../States/img/Utrar pradesh/images (34).jpeg");
hoverbg(no7, "../States/img/Utrar pradesh/images (35).jpeg");
hoverbg(no8, "../States/img/Utrar pradesh/images (36).jpeg");
hoverbg(no1, "../States/img/Utrar pradesh/images (29).jpeg");
hoverbg(no2, "../States/img/Utrar pradesh/images (30).jpeg");
hoverbg(no3, "../States/img/Utrar pradesh/images (31).jpeg");
