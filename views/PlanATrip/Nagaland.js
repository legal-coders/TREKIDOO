...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/nagaland/Khonoma/Khonoma2.jpg")';
  });
}

hoverbg(no1, "/Places/states_img/nagaland/catholic_church/catholic_church1.jpg");
hoverbg(no2, "/Places/states_img/nagaland/japfu_peak/japfu_peak1.jpg");
hoverbg(no3, "/Places/states_img/nagaland/kacgari/kacgari2.jpg");
hoverbg(no4, "/Places/states_img/nagaland/Khonoma/Khonoma1.jpg");
hoverbg(no5, "/Places/states_img/nagaland/kohima_museum/kohima_museum1.jpg");
hoverbg(no6, "/Places/states_img/nagaland/catholic_church/catholic_church2.jpg");
hoverbg(no7, "/Places/states_img/nagaland/japfu_peak/japfu_peak2.jpg");
hoverbg(no8, "/Places/states_img/nagaland/kacgari/kacgari3.jpg");
hoverbg(no9, "/Places/states_img/nagaland/Khonoma/Khonoma1.jpg");
hoverbg(no10, "/Places/states_img/nagaland/kohima_museum/kohima_museum2.jpg");
hoverbg(no11, "/Places/states_img/nagaland/kacgari/kachari-ruins1.jpg");
