...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/Uttatkhand/images (33).jpeg")';
  });
}

hoverbg(no1, "/Places/states_img/Uttatkhand/images (29).jpeg");
hoverbg(no2, "/Places/states_img/Uttatkhand/images (30).jpeg");
hoverbg(no3, "/Places/states_img/Uttatkhand/images (31).jpeg");
hoverbg(no4, "/Places/states_img/Uttatkhand/images (32).jpeg");
hoverbg(no5, "/Places/states_img/Uttatkhand/images (33).jpeg");
hoverbg(no6, "/Places/states_img/Uttatkhand/images (34).jpeg");
hoverbg(no7, "/Places/states_img/Uttatkhand/images (35).jpeg");
hoverbg(no8, "/Places/states_img/Uttatkhand/images (36).jpeg");
hoverbg(no9, "/Places/states_img/Uttatkhand/images (37).jpeg");
hoverbg(no10, "/Places/states_img/Uttatkhand/images (29).jpeg");
hoverbg(no11, "/Places/states_img/Uttatkhand/images (30).jpeg");
