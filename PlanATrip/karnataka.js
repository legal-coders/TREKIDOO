...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("../States/img/karnataka/jog_falls/Jog-Falls3.jpg")';
  });
}

hoverbg(no1, "../States/img/karnataka/aihole/aihole1.jpg");
hoverbg(no2, "../States/img/karnataka/cuban_park/cu.jpg");
hoverbg(no3, "../States/img/karnataka/jog_falls/jog_falls1.jpeg");
hoverbg(no4, "../States/img/karnataka/kodachdri/Kodachadri1.jpg");
hoverbg(no5, "../States/img/karnataka/lalbagh/Bangalore_Lalbagh-Garden3.jpg");
hoverbg(no6, "../States/img/karnataka/mulayanagiri/mullayanagiri1.jpg");
hoverbg(no7, "../States/img/karnataka/mysur_palace/Mysore-Palace4.jpg");
hoverbg(no8, "../States/img/karnataka/tadaindmol/Tadaindmol3.jpg");
hoverbg(no9, "../States/img/karnataka/lalbagh/lalbagh-botanical-garden2.jpg");
hoverbg(no10, "../States/img/karnataka/mulayanagiri/mullayanagiri4.jpg");
hoverbg(no11, "../States/img/karnataka/kodachdri/Kodachadri3.jpg");
