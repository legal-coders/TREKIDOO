...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/kerala/tea_gardens/tea_gardens1.jpg")';
  });
}

hoverbg(no1, "/Places/states_img/kerala/iulu/lulu_mall2.jpg");
hoverbg(no2, "/Places/states_img/kerala/kappad/kappad_beach1.jpg");
hoverbg(no3, "/Places/states_img/kerala/kerala_backwater/kerala_backwaters1.jpg");
