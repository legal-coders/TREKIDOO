...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/Andhra/rishikonda_beach/rishikonda_beach1.jpg"")';
  });
}

hoverbg(no1, "/Places/states_img/Andhra/ahobilam_temple/ahobilam_temple1.jpg");
hoverbg(no2, "/Places/states_img/Andhra/belum_caves/belum_caves1.jpg");
hoverbg(no3, "/Places/states_img/Andhra/borra_caves/borra_caves1.jpg");
hoverbg(no4, "/Places/states_img/Andhra/ins_museum/ins_museum1.jpg");
hoverbg(no5, "/Places/states_img/Andhra/kailasagiri/kailasagiri1.jpg");
hoverbg(no6, "/Places/states_img/Andhra/rishikonda_beach/rishikonda_beach4.jpg");
hoverbg(no7, "/Places/states_img/Andhra/tada_falls/tada_falls1.jpg");
hoverbg(no8, "/Places/states_img/Andhra/thirumala/tirumala_temple1.jpg");
hoverbg(no9, "/Places/states_img/Andhra/belum_caves/belum_caves2.jpg");
hoverbg(no10, "/Places/states_img/Andhra/kailasagiri/kailasagiri2.jpg");
hoverbg(no11, "/Places/states_img/Andhra/rishikonda_beach/rishikonda_beach3.jpg");
