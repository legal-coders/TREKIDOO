...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/Uttatkhand/images (33).jpg")';
  });
}

hoverbg(no1, "/Places/states_img/Uttatkhand/images (29).jpg");
hoverbg(no2, "/Places/states_img/Uttatkhand/images (30).jpg");
hoverbg(no3, "/Places/states_img/Uttatkhand/images (31).jpg");
hoverbg(no4, "/Places/states_img/Uttatkhand/images (32).jpg");
hoverbg(no5, "/Places/states_img/Uttatkhand/images (33).jpg");
hoverbg(no6, "/Places/states_img/Uttatkhand/images (34).jpg");
hoverbg(no7, "/Places/states_img/Uttatkhand/images (35).jpg");
hoverbg(no8, "/Places/states_img/Uttatkhand/images (36).jpg");
hoverbg(no9, "/Places/states_img/Uttatkhand/images (37).jpg");
hoverbg(no10, "/Places/states_img/Uttatkhand/images (29).jpg");
hoverbg(no11, "/Places/states_img/Uttatkhand/images (30).jpg");
