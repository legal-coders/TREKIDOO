...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("../States/img/Chattisgarh/Ghatarni_waterfall/Ghatarani_waterfall1.jpg")';
  });
}

hoverbg(
  no1,
  "../States/img/Chattisgarh/Achanakmar_wildlife_sanctuary/Achanakmar_wildlife_sanctuary.jpg"
);
hoverbg(
  no2,
  "../States/img/Chattisgarh/Chitrakote_Waterfall/ChitrakoteWaterfall1.jpg"
);
hoverbg(
  no3,
  "../States/img/Chattisgarh/Ghatarni_waterfall/Ghataraniwaterfall2.jpg"
);
hoverbg(
  no4,
  "../States/img/Chattisgarh/Ibrahim_rauza_tomb/Ibrahimrauzatomb1.jpg"
);
hoverbg(no5, "../States/img/Chattisgarh/Jatmai_Temple/Jatmai_Temple.jpg");
hoverbg(
  no6,
  "../States/img/Chattisgarh/Naya_raipur_central_park/Naya_Raipur_central_Park1.jpg"
);
hoverbg(
  no7,
  "../States/img/Chattisgarh/Purkhouti_Muktangan/PurkhoutiMuktangan2.jpg"
);
hoverbg(
  no8,
  "../States/img/Chattisgarh/Shaheed_veer_narayan_singh_international_cricket_stadium/Shaheed_veer_narayan_singh_international_cricket_stadium1.jpg"
);
hoverbg(
  no9,
  "../States/img/Chattisgarh/Achanakmar_wildlife_sanctuary/Achanakmar_wildlife_sanctuary3.JPG"
);
hoverbg(
  no10,
  "../States/img/Chattisgarh/Chitrakote_Waterfall/ChitrakoteWaterfall3.jpg"
);
hoverbg(
  no11,
  "../States/img/Chattisgarh/Ghatarni_waterfall/GhataraniWaterfall3.jpg"
);
