...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/karnataka/jog_falls/Jog-Falls3.jpg")';
  });
}
...
hoverbg(no7, "/Places/states_img/karnataka/mysur_palace/Mysore-Palace4.jpg");
hoverbg(no8, "/Places/states_img/karnataka/tadaindmol/Tadaindmol3.jpg");
hoverbg(no9, "/Places/states_img/karnataka/lalbagh/lalbagh-botanical-garden2.jpg");
hoverbg(no10, "/Places/states_img/karnataka/mulayanagiri/mullayanagiri4.jpg");
hoverbg(no11, "/Places/states_img/karnataka/kodachdri/Kodachadri3.jpg");
