...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("../States/img/punjab/images (35).jpeg")';
  });
}

hoverbg(no1, "../States/img/punjab/images (34).jpeg");
hoverbg(no2, "../States/img/punjab/images (35).jpeg");
hoverbg(no3, "../States/img/punjab/images (36).jpeg");
hoverbg(no4, "../States/img/punjab/images (37).jpeg");
hoverbg(no5, "../States/img/punjab/images (38).jpeg");
hoverbg(no6, "../States/img/punjab/images (39).jpeg");
hoverbg(no7, "../States/img/punjab/images (40).jpeg");
hoverbg(no8, "../States/img/punjab/images (41).jpeg");
hoverbg(no9, "../States/img/punjab/images (34).jpeg");
hoverbg(no10, "../States/img/punjab/images (35).jpeg");
hoverbg(no11, "../States/img/punjab/images (36).jpeg");
