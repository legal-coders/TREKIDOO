...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/Maharastra/mahabaleshwar/mahabaleshwar3.jpg")';
  });
}

hoverbg(no1, "/Places/states_img/Maharastra/alibag/alibag1.jpg");
hoverbg(no2, "/Places/states_img/Maharastra/Aurangabad/Aurangabad1.jpg");
hoverbg(no3, "/Places/states_img/Maharastra/kolhapur/kolhapur1.jpg");
hoverbg(no4, "/Places/states_img/Maharastra/mahabaleshwar/mahabaleshwar1.jpg");
hoverbg(no5, "/Places/states_img/Maharastra/matheran/matheran1.jpg");
hoverbg(no6, "/Places/states_img/Maharastra/mumbai/mumbai1.jpg");
hoverbg(no7, "/Places/states_img/Maharastra/nashik/nashik1.jpg");
hoverbg(no8, "/Places/states_img/Maharastra/solapur/solapur1.jpg");
hoverbg(no9, "/Places/states_img/Maharastra/alibag/alibag2.jpg");
hoverbg(no10, "/Places/states_img/Maharastra/Aurangabad/Aurangabad2.jpg");
hoverbg(no11, "/Places/states_img/Maharastra/kolhapur/kolhapur2.jpg");
