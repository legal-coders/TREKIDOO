...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/goa/chapora_beach/chapora_beach1.jpg")';
  });
}

hoverbg(no1, "/Places/states_img/goa/bondla_wildlife_sanctuary/bondla_wildlife_sanctuary1.jpg");
hoverbg(no2, "/Places/states_img/goa/calangute_beach/calangute_beach1.jpg");
hoverbg(no3, "/Places/states_img/goa/chapora_beach/chapora_beach2.jpg");
hoverbg(no4, "/Places/states_img/goa/church_of_our_lady_of_hope/church_of_our_lady_of_hope1.jpg");
hoverbg(no5, "/Places/states_img/goa/divar_island/divar_island1.jpg");
hoverbg(no6, "/Places/states_img/goa/mangesh_temple/mangesh_temple1.jpg");
