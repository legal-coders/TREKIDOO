...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("../States/img/Telangana/Ananthagiri-Hills.jpg")';
  });
}

hoverbg(no1, "../States/img/Telangana/Ananthagiri-Hills.jpg");
hoverbg(no2, "../States/img/Telangana/Chowmahalla.jpg");
hoverbg(no3, "../States/img/Telangana/Golkonda_Fort.jpg");
hoverbg(no4, "../States/img/Telangana/laknavaram.jpg");
hoverbg(no5, "../States/img/Telangana/ramappa.jpeg");
hoverbg(no6, "../States/img/Telangana/Reiek.jpg");
hoverbg(no7, "../States/img/Telangana/salar-jung-museum.jpg");
hoverbg(no8, "../States/img/Telangana/saraswathi.jpg");
hoverbg(no9, "../States/img/Telangana/Ananthagiri-Hills.jpg");
hoverbg(no10, "../States/img/Telangana/Chowmahalla.jpg");
hoverbg(no11, "../States/img/Telangana/Golkonda_Fort.jpg");
