...
function hoverbg(card, url) {
  ...
  card.addEventListener("mouseout", () => {
    secondcontainer.style.backgroundImage =
      'url("/Places/states_img/Tamilnadu/Marina_beach/Marina1.jpg")';
  });
}

hoverbg(no1, "States/img/Tamilnadu/Big_temple/big-temple.jpg");
hoverbg(no2, "/Places/states_img/Tamilnadu/Dhanushkodi/dhanushkodi1.jpg");
hoverbg(no3, "/Places/states_img/Tamilnadu/Mahabalipuram/Mahabalipuram1.jpg");
hoverbg(no4, "/Places/states_img/Tamilnadu/Marina_beach/marina2.jpg");
hoverbg(no5, "/Places/states_img/Tamilnadu/Meenakshi_amman/amman1.jpg");
hoverbg(no6, "/Places/states_img/Tamilnadu/Big_temple/Bigtemple.jpg");
hoverbg(no7, "/Places/states_img/Tamilnadu/Dhanushkodi/dhanushkodi2.jpg");
hoverbg(no8, "/Places/states_img/Tamilnadu/Mahabalipuram/mahabalipuram2.jpg");
hoverbg(no9, "/Places/states_img/Tamilnadu/Marina_beach/marina2.jpg");
hoverbg(no10, "/Places/states_img/Tamilnadu/Meenakshi_amman/amman2.jpg");
hoverbg(no11, "/Places/states_img/Tamilnadu/Marina_beach/marina3.jpg");
